...
public class PropWorthPageLocator {
	...
	public static final By propertytype = By.xpath("// label[@class='filter__common__component__item__label propertytype propertytype_10002']");
	...
	public static final By interior = By.xpath("// label[@class='filter__common__component__item__label interiors interiors_19900']");
	...
	public static final By scrolladd = By.xpath("//div[@class='filter__common__component__title' and text()='Overlooking']");
